...
namespace CarPool
{
    ...
    {
        public List<PoolProviderDetails> poolProviderDetailsList =  new PoolProviderDetails().getList();
        public List<UserDetailsList> userDetailsList =  new UserDetailsList().getUserList();
        public UserDetailsList userDetails = new UserDetailsList();
        public List<VehicleDetails> vehicleDetailsList =  new VehicleDetails().getVehicleList();
        ...
        public void displayRiders(PoolProviderDetails poolProviderDetails)
        {
            ...
            if (poolProviderDetails.Riders.Count > 0)
            {
                ...
                {
                    UserDetailsList user = userDetails.getUserDetails(rider);
